// Calculations - May 2018
// Write a Java program that accepts two integers and then prints:
// sum, difference, product, average, the distance (the difference between integer),
